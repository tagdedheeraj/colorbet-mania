...
const SupportContactPopup = () => {
  ...
  return (
    <>
      {/* For mobile - fixed bottom button */}
      {isMobile && (
        <div className="fixed bottom-16 right-4 z-40">
          <Sheet open={isPopupOpen} onOpenChange={setIsPopupOpen}>
            ...
            <SheetContent side="bottom" className="rounded-t-xl pt-1 pb-6 px-4">
              <div className="mx-auto mt-1 h-1.5 w-16 rounded-full bg-muted mb-4" />
